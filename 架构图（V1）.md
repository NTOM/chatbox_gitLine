...
- 🌳 **节点式对话视图（V1新增）**: 可视化对话分支树，支持 Git 风格的分支管理
...
│   │   │   ├── viewModeStore.ts    # 【V1新增】视图模式状态
│   │   │   ├── migration.ts        # 数据迁移
│   │   │   └── atoms/              # Jotai原子状态
│   │   │
│   │   ├── lib/                    # 工具库
│   │   │   ├── conversation-tree-adapter.ts  # 【V1新增】Session ↔ Tree 转换
│   │   │   ├── tree-layout.ts                # 【V1新增】dagre 布局算法
│   │   │   └── ...
│   │   │
│   │   ├── hooks/                  # 自定义Hooks
│   │   ├── modals/                 # 模态对话框
...
interface ViewModeState {
  ...
  treeZoom: number             // 缩放级别
  treePosition: { x: number; y: number } // 画布位置
}
```
...
// src/renderer/stores/viewModeStore.ts (V1新增)
